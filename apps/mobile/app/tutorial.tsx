...
const STEPS = [
  {
    emoji: '✏️',
    title: "Hi! I'm Pip the Pencil!",
    body: "Welcome to Doodle Dash — the drawing game where personality beats skill!",
    cta: "Let's go!",
  },
  {
    emoji: '🎯',
    title: "You get a prompt",
    body: "Every round, everyone gets the SAME drawing prompt. You have 60 seconds to draw it YOUR way.",
    cta: "Got it!",
  },
  {
    emoji: '🎨',
    title: "Draw your heart out",
    body: "Use brushes, colors, the eraser, and bucket fill. Each round you get ONE magic stamp ✨ — use it wisely!",
    cta: "Cool!",
  },
  {
    emoji: '⭐',
    title: "Vote for your faves",
    body: "After everyone draws, vote for Most Creative, Funniest, and Best Match. The AI judge scores everyone too!",
    cta: "Sounds fun!",
  },
  {
    emoji: '🏆',
    title: "Skill doesn't matter",
    body: "The worst drawing can still WIN if it's funny or creative. That's the whole point!",
    cta: "Let's play!",
  },
];
...
const styles = StyleSheet.create({
  ...
  ctaBtn: {
    backgroundColor: '#fff', borderRadius: 20, paddingHorizontal: 40, paddingVertical: 16,
