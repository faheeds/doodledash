...
export default function DrawScreen({ navigation, route }: Props) {
  const { prompt, sketchbookId, level, isDailyDoodle } = route.params;
  ...
  const handleTimeUp = useCallback(async () => {
    ...
    navigation.replace('Result', { prompt, entryId, sketchbookId, level, isDailyDoodle });
  }, [prompt, navigation, sketchbookId, level, isDailyDoodle]);
