    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.container}>
        ...
        <View style={styles.actions}>
          ...
          <TouchableOpacity style={styles.startBtn} onPress={() => navigation.navigate('Draw', { prompt })}>
...
const styles = StyleSheet.create({
  ...
  promptCard: { backgroundColor: '#fff', borderRadius: 20, padding: 32, alignItems: 'center', marginBottom: 32, elevation: 3, borderWidth: 2, borderColor: COLORS.primary },
  ...
  shuffleBtn: { backgroundColor: '#fff', borderRadius: 16, padding: 16, alignItems: 'center', borderWidth: 2, borderColor: COLORS.primary },
